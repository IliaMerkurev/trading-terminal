...
References: [React Flow instance](https://reactflow.dev/api-reference/types/react-flow-instance), [context menu](https://reactflow.dev/examples/interaction/context-menu), [0.1 desktop](0007-desktop.md).
