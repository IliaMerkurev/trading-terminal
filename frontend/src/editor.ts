...
export const fullNames:Record<NodeKind,string>={price:'Open High Low Close Volume',constant:'Numeric Constant',sma:'Simple Moving Average',ema:'Exponential Moving Average',rsi:'Relative Strength Index',bb:'Bollinger Bands',macd:'Moving Average Convergence Divergence',atr:'Average True Range',compare:'Compare',cross_above:'Cross Above',cross_below:'Cross Below',and:'Boolean AND',or:'Boolean OR',not:'Boolean NOT'};
export const groups:Record<NodeKind,string>={price:'Sources',constant:'Sources',sma:'Indicators',ema:'Indicators',rsi:'Indicators',bb:'Indicators',macd:'Indicators',atr:'Indicators',compare:'Conditions',cross_above:'Conditions',cross_below:'Conditions',and:'Logic',or:'Logic',not:'Logic'};
